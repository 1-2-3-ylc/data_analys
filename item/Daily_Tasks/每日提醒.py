...
class Tips:
    ...
    def select_date(self):
        ...
        FROM (
        SELECT  t.order_number,t.true_name,t.user_mobile,t.product_name,t.create_time, t.refund_date,t.reality_refund_date,t.money
        ...
        om.order_number,tmu.true_name,om.user_mobile,tod.product_name,om.create_time,ymos.refund_date,ymos.reality_refund_date
    ...
    def run(self):
        df = self.select_date()
        df_xs = df[['订单号', '姓名', '手机号', '产品名称', '下单日期', '预计还款日期', '应付金额']].drop_duplicates()
